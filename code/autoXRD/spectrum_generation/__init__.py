...
class SpectraGenerator(object):
    ...
    def __init__(self, reference_dir, num_spectra=50, max_texture=0.6, min_domain_size=1.0, max_domain_size=100.0, max_strain=0.04, max_shift=0.25, impur_amt=70.0, min_angle=10.0, max_angle=80.0, separate=True, is_pdf=False, max_cpu=8):
        """
        Args:
        ...
        if max_cpu is None:
            ...
            self.num_cpu = min(max_cpu, multiprocessing.cpu_count())
