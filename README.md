...
- [xrd_server](https://github.com/tacmon/xrd_server)：（当前项目）服务器版本，将 XRD 分析固化为容器化线上接口，提供在线分析与 API 批处理服务。

本项目致力于为您打造一个高效、稳健且高度工程化的 XRD 生产级服务体验。如果有任何建议，欢迎随时交流！

---

> [!NOTE]
> 本项目核心架构与容器化重构由 **Google Gemini** 大模型全流程协助分析与完成。
